...
// this is an Instance of Student / Joe
// 2. What is "this" when joe.scopeArrow() is invoked?
// this becomes what looks like the Window object of the tab in the browser itself
// 3. Explain why "this" is different when an arrow function is used.
// After a google search, I learned that arrow functions take the this from their surroundings (lexical binding). With arrow functions the this keyword always represents the object that defined the arrow function. In this case, the Window... Arrow functions are always anonymous. This means you cannot bind a value to this...
